const sqls = {
    createDB:[`CREATE DATABASE IF NOT EXISTS blog`,`use blog`,`ALTER DATABASE blog DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci`],
    createArticleTb:`CREATE TABLE  IF NOT EXISTS article (
 ...
 PRIMARY KEY (article_id)
    ...
    createUserGroupTb:`CREATE TABLE  IF NOT EXISTS user_group (
 ...
 PRIMARY KEY (g_id)
    ...
    createFeatureAuthTb:`CREATE TABLE  IF NOT EXISTS feature_auth (
 ...
 PRIMARY KEY (p_id)
    ...
    createFriendListTb:`CREATE TABLE  IF NOT EXISTS friend (
 f_id smallint(5) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
 user_id mediumint(8) NOT NULL COMMENT '用户ID',
 friend_id mediumint(8) NOT NULL COMMENT '好友ID',
 PRIMARY KEY (f_id)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ;`,
    createUserConcernListTb:`CREATE TABLE  IF NOT EXISTS user_attention (
...
`,
    createUserPrivateLetterTb:`CREATE TABLE  IF NOT EXISTS secret_message (
...
`,
 ...
 PRIMARY KEY (ad_id)
    ...
    createUserLeaveWordTb:`CREATE TABLE  IF NOT EXISTS stay_message (
 ...
 PRIMARY KEY (stay_id)
    ...
    createBlogInfoTb:`CREATE TABLE  IF NOT EXISTS about_blog (
 ...
 PRIMARY KEY (blog_id)
    ...
    createLastVisitorTb:`CREATE TABLE  IF NOT EXISTS visitor (
 ...
 PRIMARY KEY (v_id)
    ...
    createUserShuoShuoTb:`CREATE TABLE  IF NOT EXISTS shuoshuo (
 ...
 PRIMARY KEY (shuo_id)
    ...
    createPhotoSortTb:`CREATE TABLE  IF NOT EXISTS photo_sort (
 ...
 PRIMARY KEY (sort_img_id)
    ...
    createPhotoTb:`CREATE TABLE  IF NOT EXISTS photos (
 ...
 PRIMARY KEY (photo_id) 
    ...
    createArticleSortTb:`CREATE TABLE  IF NOT EXISTS article_sort (
 ...
 PRIMARY KEY (sort_article_id)
    ...
    createArticleTagTb:`CREATE TABLE  IF NOT EXISTS article_tag (
 tag_id mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '标签ID',
 user_id mediumint(8) NOT NULL  COMMENT '用户ID', 
 tag_name varchar(60) NOT NULL COMMENT '标签名',
 PRIMARY KEY (tag_id)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ;`,
    createArticleTagMapTb:`CREATE TABLE  IF NOT EXISTS article_tag_map (
 ...
 PRIMARY KEY (tag_article_id)
    ...
    createUserCommentTb:`CREATE TABLE  IF NOT EXISTS user_comment (
 comment_id mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '评论自增ID号',
 comment_target_user_id mediumint(8) NOT NULL COMMENT '收到评论的用户ID',
...
CREATE TABLE  IF NOT EXISTS user_sub_comment (
 ...
 PRIMARY KEY (comment_id)
    ...
    createSMSTb:`CREATE TABLE  IF NOT EXISTS phone_message (
 ...
 PRIMARY KEY (phone_id)
    ...
    createSiteManagerTb:`CREATE TABLE  IF NOT EXISTS blog_manager (
 ...
 PRIMARY KEY (m_id)
  ...
  createUserDynamicTb:` CREATE TABLE  IF NOT EXISTS user_dynamic (
