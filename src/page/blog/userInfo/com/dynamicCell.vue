           ...
           <div class="dynamicComment" v-if = "dynamicInfo.dynamic_type_id == 1 || dynamicInfo.dynamic_type_id == 12 || dynamicInfo.dynamic_type_id == 13">
            <div class="articleCellContent">
                ...
                <div class="articleTailInfo">
                    <span class="articleTailSortName" v-if="!!dynamicInfo.selfObject.article_sort_name"  >{{dynamicInfo.selfObject.article_sort_name}}</span> <i class="fa fa-eye"  aria-hidden="true"></i>
